// Input (JSX):
define(['react', 'Navigation', 'AddPost', 'AppActions', 'cookie', 'bootstrap', 'snackbars'], function(React, Navigation, AddPost, AppActions) {
        ...
        render: function () {
            return (
                <div className="app_container">
                    <Navigation user={this.state.user} loginUserHandler={this.loginUser} logoutUserHandler={this.logoutUser}/>
